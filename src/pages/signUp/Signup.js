...
const addData = (e) => {
  ...
  return (
    <section className='container mx-auto bg-login-image'>
      ...
      <div className='w-2/3 mx-auto'>
        ...
        {/* {profile ? (
              ...
              <button onClick={logOut}>Log out</button>
                ...
                <button className='w-full' onClick={() => login()}><GoogleLogin isSignedIn={true} className=""  /></button>
            )} */}
            <button className='w-full' onClick={() => login()}><GoogleLogin isSignedIn={true} className=""  /></button>
        </div>
      </div>
      {/* end */}
      <div className="relative w-2/3 mx-auto p-5">
  ...
  <span className="relative bg-white px-4">or</span>
      ...
      <div className='w-2/3 mx-auto '>
        ...
        <form >
          <input className='w-full border border-solid border-gray-200 px-4 py-2 mt-4 
          placeholder-gray-500::placeholder rounded-md ' 
          type='text' placeholder='Email' name='email'
          onChange={getdata} required/>
          <input className='w-full border border-solid border-gray-200 px-4 py-2 mt-4 
          placeholder-gray-500::placeholder rounded-md ' type='password'
          
          onChange={getdata} name='password' placeholder='Password' required/>

          <button type='submit'onClick={addData} className='bg-green-600 text-white w-full px-5 py-3 rounded-md mt-2'>Continue</button>
        </form>
        

        <div className='mt-5'>
          <small className='text-gray-500 font-light w-full'>By creating an account, you are agreeing to our</small><br />
          <small><a href='t' className='text-green-600'>Terms of Service</a> and <a href='p' className='text-green-600'>Privacy Policy.</a></small>
        </div>
      </div>

      <div className='pt-8 pb-10'>
        <p className='text-gray-500 font-light text-sm'>Already have an account?</p>
        <a href='/log-in' className='text-green-600'>Sign in</a>
      </div>
    </div>
    </section>
  )
